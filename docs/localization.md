...
You just need to copy and paste [Editor buttons](https://github.com/Raiper34/bii-text-editor/blob/main/projects/bii-text-editor/src/lib/constants/editor-buttons.ts) into your code base, rewrite the `label`s, and `title`s, and use it in `EditorConfig` editor configuration.
...
// copy pasted code, just modify titles and labels as you wish
...
export const TRANSLATED_BUTTONS: ToolbarItem[] = [
  UNDO_BUTTON,
  REDO_BUTTON,
